...
import { COL_COUNT, MAX_TIME, ROW_COUNT } from './Bourdon/Constants';
...
export function Bourdon(){
    ...
    let store = useTestStore(({startTime, endTime, hasStarted, hasEnded, endTest, startTest, letters})=>({
        startTime, endTime, hasStarted, hasEnded, endTest, startTest, letters
    }), shallow);
