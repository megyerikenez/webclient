    ...
    return (
      <>
        <div className="px-6">
          ...
          <p>
            {t("tests.chairLamp.description.1")}A következő feladatban kapni fog
            4 féle négyzetet, azokat kell megtalálnia, és bejelölnie
            (kattintással).
          </p>
          <p>
            Összesen {getImgRes().length} fajta négyzet van, azok az alábbi
            módon néznek ki:
          </p>
          <div className="my-2">
            {getImgRes().map((res) => {
